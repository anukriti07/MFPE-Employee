...
insert into Employee(id,name,gender,age) values(1,'Shubhangi','female',21);
insert into Employee(id,name,gender,age) values(2,'Anukriti','female',31);
insert into Employee(id,name,gender,age) values(3,'Tarun','male',24);
